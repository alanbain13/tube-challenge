-- Fix the derive_activity_state function to use created_at instead of updated_at
...
BEGIN
    ...
    -- Create state version from created_at timestamp (since updated_at doesn't exist)
