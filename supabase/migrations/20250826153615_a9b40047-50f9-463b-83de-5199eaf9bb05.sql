-- Update derive_activity_state function for free-order check-ins
...
DECLARE
    ...
    activity_started boolean := false;
BEGIN
    -- Get the activity
    ...
    RETURN jsonb_build_object(
        ...
        'counts', jsonb_build_object(
            ...
            'visited_actual', array_length(actual_visits_array, 1) COALESCE 0,
